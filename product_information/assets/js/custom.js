$(document).ready( function() {
	...
	$('#login').on('click', function(e) {
		...
		if ( (username == "") || (password == "") ) {
			feedback.removeClass().addClass('alert alert-error').text('Please enter your details!').fadeIn();
			load.fadeOut();
			return false;
		}
		...
		$.ajax({
			...
			data: {
				...
				feedback.removeClass().addClass('alert alert-block').text('Something went wrong. Please check the console for more information.').fadeIn();
				load.fadeOut();
	...
	$('#register').on('click', function(e) {
		...
		if ((registerUsername == "") || (registerPassword == "") || (registerEmail == "") || (registerCaptcha == "")) {
			feedback.removeClass().addClass('alert alert-error').text('Please fill out all of the above fields.').fadeIn();
			load.fadeOut();
			return false;
		}
	...
	$('#forgot-password').on('click', function() {
		...
		if (forgotEmail == "") {
			load.fadeOut();
			feedback.removeClass().addClass('alert alert-error').text('Please enter your email so that I can work with it!').fadeIn();
			return false;
		}
	...
	$('#renew-password').on('click', function() {
		...
		if ( (passwordOne == "") || (passwordTwo == "") || (emailReset == "") || resetCode == "") {
			load.fadeOut();
			feedback.removeClass().addClass('alert alert-error').text('Please enter your new password, two times!').fadeIn();
			return false;
		}
